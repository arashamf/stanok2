...
#define DIR1_DRIVE(x) ((x)? (LL_GPIO_SetOutputPin (DIR1_GPIO_Port, DIR1_Pin)) : (LL_GPIO_ResetOutputPin(DIR1_GPIO_Port, DIR1_Pin)))
#define DIR2_DRIVE(x) ((x)? (LL_GPIO_SetOutputPin (DIR2_GPIO_Port, DIR2_Pin)) : (LL_GPIO_ResetOutputPin(DIR2_GPIO_Port, DIR2_Pin)))
...
#define DRIVE2_ENABLE(x) ((x)? (LL_GPIO_SetOutputPin (ENABLE2_Port, ENABLE2_Pin)) : (LL_GPIO_ResetOutputPin(ENABLE2_GPIO_Port, ENABLE2_Pin)))
